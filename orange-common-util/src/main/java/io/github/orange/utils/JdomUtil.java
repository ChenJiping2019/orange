...
public class JdomUtil
{
     ...
     * @param charset 编码格式，如果为<code>null</code>,则取{@link #DEFAULT_ENCODING}
     ...
     * 默认消除边界空白进行xml字节数组解析
     * @param bytes xml字节数组
     * @param charset 编码格式，如果为 null,则取 {@link #DEFAULT_ENCODING}
     * @return 根据xml数据输入流构建 {@link Document}
     * @throws JDOMException 解析异常
     * @throws IOException 流入流读取异常
     */
    ...
    /**
     * 默认采用 {@link #DEFAULT_ENCODING}编码并消除边界空白进行xml字节数组解析
     * @param bytes xml字节数组
     * @return 根据xml数据输入流构建 {@link Document}
     * @throws JDOMException 解析异常
     * @throws IOException 流入流读取异常
    ...
    /**
     * 按默认编码格式{@link #DEFAULT_ENCODING}格式化{@link Document}对象
     * @param document 待转换的{@link Document}对象
     * @return 如果document为 <code>null</code>,则返回 <code>null</code>
     * @throws IOException 转换成字节流异常
     */
    ...
    /**
     * 按默认编码格式{@link #DEFAULT_ENCODING}转换{@link Document}对象
     * @param document 待转换的{@link Document}对象
     * @return 如果document为<code>null</code>,则返回<code>null</code>
     * @throws IOException 转换成字节流异常
     */
    ...
    /**
     * 采用默认编码格式{@link #DEFAULT_ENCODING}进行处理
     * @param element 待转换的{@link Element}对象
     * @return 如果element为空，则返回<code>null</code>
     * @throws IOException 转换成字节流异常
     */
